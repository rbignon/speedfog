...
| `HalloweenIconPatcher` | Ships Golden Seed/Sacred Tear pumpkin/gumdrop icons as a 05_dummy.tpf.dcx superset (`--halloween-dir`, opt-in overlay output, see `docs/plugins/halloween-icons.md`) |
