...
│   │   └── halloween_icon_sacred_gumdrop.png  # Sacred Tear placeholder icon art, 160x160 (tracked)
│   ├── i18n/                # Localization
...
│       ├── halloween-icons.md  # Halloween item icon redirect (Golden Seed, Larval Tear, Sacred Tear)
...
| `docs/plugins/halloween-icons.md` | Halloween item icon redirect (Golden Seed, Larval Tear, Sacred Tear): 05_dummy overlay + iconId redirect, EXPERIMENT status, revert path, fallbacks |
...
| `HalloweenIconInjector` | Repoints Golden Seed/Larval Tear/Sacred Tear `EquipParamGoods.iconId` to the Halloween 05_dummy overlay textures (opt-in via `[plugin.halloween]`, see `docs/plugins/halloween-icons.md`) |
...
| `HalloweenIconPatcher` | Ships Golden Seed/Larval Tear/Sacred Tear pumpkin/gummy-worm/gumdrop icons as a 05_dummy.tpf.dcx superset (`--halloween-dir`, opt-in overlay output, see `docs/plugins/halloween-icons.md`) |
