...
│   ├── packaging/           # Seed package template (scripts, ModEngine 2, runtime DLLs)
│   ├── overlay-src/         # Overlay source files (tracked, e.g. lua scripts to repack)
│   │   └── script/<name>-luabnd-dcx/  # WitchyBND-unpacked layout, repacked at bootstrap
│   └── overlay/             # GamePatcher output + WitchyBND repacks + user overrides (gitignored)
