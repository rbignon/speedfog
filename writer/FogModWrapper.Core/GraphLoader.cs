...
public static class GraphLoader
{
    ...
    public static GraphData Parse(string json)
    {
        ...
        // Validate version
        if (data.Version != "3.0" && data.Version != "4.0" && data.Version != "4.1" && data.Version != "4.2" && data.Version != "4.3" && data.Version != "4.4" && data.Version != "4.5" && data.Version != "4.6")
        {
            Console.WriteLine($"Warning: Expected graph.json version 3.0, 4.0, 4.1, 4.2, 4.3, 4.4, 4.5, or 4.6, got {data.Version}");
        }
