...
public class ClassLoadoutInjectorTests
{
    ...
    /// <summary>
    /// CharaInitParam-shaped PARAM with the six equip fields the injector
    /// writes, all int fields as sentinel-carrying stand-ins for the vanilla
    /// def's real types (mirrors StartingClassRowsTests/StartingRuneInjectorTests).
    /// </summary>
