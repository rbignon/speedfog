...
Gives Golden Seed and Sacred Tear custom pumpkin / gumdrop inventory
icons on Halloween seeds, matching the
item renames already done by the
text theme (`Pumpkin Seed`, `Sacred Gumdrop`; see
...
`data/plugins/halloween_icon_pumpkin_seed.png` and
...
("Pumpkin Seed") and Sacred Tear ("Sacred Gumdrop") icons. Custom
pumpkin / gumdrop art
