...
- **EMEVD scan (m10_01_00_00)** IntroCutscenePatcher: replace the new-game intro cutscene (10000040) in event 10010020 by SetCurrentTime(23:45) + ChangeWeather(Default); see `docs/chapel-grace.md`
