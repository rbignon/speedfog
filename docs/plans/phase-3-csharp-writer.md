...
**Last updated**: 2026-02-01 (zone_maps integrated into clusters.json, zones_data.json removed)
...
public class ModWriter
{
    ...
    private void LoadSpeedFogData()
    {
        ...
        _clusterFile = ClusterFile.Load(clustersPath);
        Console.WriteLine($"  Loaded {_clusterFile.ZoneMaps.Count} zone→map entries");
